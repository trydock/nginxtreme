...
ENV NGINX_MODULE_RTMP_VERSION 1.2.1
...
RUN GPG_KEYS=B0F4253373F8F6F510D42178520A9993A1C052F8 \
	...
	&& curl -fSL https://github.com/vozlt/nginx-module-vts/archive/v$NGINX_MODULE_VTS_VERSION.tar.gz -o nginx-mod-vpts.tar.gz \
	&& curl -fSL https://github.com/arut/nginx-rtmp-module/archive/v$NGINX_MODULE_RTMP_VERSION.tar.gz -o nginx-mod-rtmp.tar.gz \
